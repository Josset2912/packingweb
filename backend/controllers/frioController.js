...
const getFrioData = async (req, res) => {
  try {
    ...
    const result = await pool.request().query("SELECT * FROM FRIO");
...
const addFrioData = async (req, res) => {
  ...
  try {
    ...
    await emitirDatosActualizados("FRIO");
...
module.exports = { getFrioData, addFrioData };
...
module.exports = { getFrioData }; // ✅ Exportando correctamente
*/
